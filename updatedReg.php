...
include_once 'updatedRegData.php';
...
<html>
    <head>
        <meta charset="UTF-8">
        <title>Registation - UPDATE</title>
                                            ...
                                            while ($row = $result->fetch_assoc()) {
                                                ...
                                                <form 
                                                    ...
                                                    <div class="form-floating mb-3">
                                                        ...
                                                        <label for="floatingInput"><?php echo $row["UserName"]; ?></label>
                                                    </div>
                                                    <div class="form-floating mb-3">
                                                        <input type="email" class="form-control" id="floatingInput" name="email"
                                                               placeholder="Email" required="*">
                                                        <label for="floatingInput"><?php echo $row["Email"]; ?></label>
                                                    </div>
                                                    <div class="form-floating mb-3">
                                                        <input type="number" class="form-control" id="floatingInput"
                                                               name="contact_number" placeholder="contact number">
                                                        <label for="floatingInput"><?php echo $row["ContactNumber"]; ?></label>
                                                    </div>
                                                    <div class="form-floating mb-3">
                                                    ...
                                                    <div class="input-group mb-3">
                                                        ...
                                                        <output 
                                                            class="text-dark">
                                                                <?php echo $row["SkillRange"]; ?>
                                                        </output>
                                                    </div>

                                                    <div class="input-group mb-3">
                                                        <span class="input-group-text">Addres: <?php echo $row["Address"]; ?></span>
                                                        <textarea 
                                                            class="form-control"
                                                            name="address_Field"
                                                    ...
                                                    <div class="text-center">
                                                        <button type="submit" name="userUpdate_submit" class="btn btn-primary">Submit</button>
                                                    </div>
                                                </form>
                                                <?php
                                            }
